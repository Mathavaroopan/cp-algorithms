...
void solve(){
    ...
    if((arr[0][0] == arr[0][1] && arr[0][1] == arr[0][2] && arr[0][0] != '.')) ans = arr[0][0];
    else if((arr[1][0] == arr[1][1] && arr[1][1] == arr[1][2] && arr[1][0] != '.')) ans = arr[1][0];
    else if((arr[2][0] == arr[2][1] && arr[2][1] == arr[2][2] && arr[2][0] != '.')) ans = arr[2][0];
    else if(arr[0][0] == arr[1][0] && arr[1][0] == arr[2][0] && arr[0][0] != '.') ans = arr[0][0];
    else if(arr[0][1] == arr[1][1] && arr[1][1] == arr[2][1] && arr[0][1] != '.') ans = arr[0][1];
    else if(arr[0][2] == arr[1][2] && arr[1][2] == arr[2][2] && arr[0][2] != '.') ans = arr[0][2];
    else if(arr[0][0] == arr[1][1] && arr[1][1] == arr[2][2] && arr[0][0] != '.') ans = arr[2][2];
    else if(arr[2][0] == arr[1][1] && arr[1][1] == arr[0][2] && arr[2][0] != '.') ans = arr[1][1];
    cout << ans << endl;
}
